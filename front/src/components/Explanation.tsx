...
export default function Explanation() {
  ...
  return (
    <section className='mb-5'>
      ...
      >
        <h2 className='text-3xl font-lexendBold text-white max-[500px]:text-xl max-[700px]:text-2xl'>
          <span>{info ? '-' : '+'}</span> ¿Cómo funciona?
        </h2>
      </div>
      {info && (
          ...
          <div className='mb-4'>
            ...
            <div className='bg-white px-2 py-3 rounded'>
              <div className='relative grid gap-3 p-4 grid-cols-5 max-ph:grid-cols-1 items-center rounded-md border-black border-2 whitespace-nowrap'>
                ...
                <span className='absolute right-[15px] top-[11px] flex items-center gap-1 bg-primary py-1 px-2 text-white rounded-md'>
                  Añadir
                  <svg
                    stroke='#ffffff'
                    stroke-width='2px'
